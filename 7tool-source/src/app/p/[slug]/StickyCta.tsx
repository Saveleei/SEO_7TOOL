      ...
      <div className="border-t border-steel-200 bg-white/95 px-3 py-2.5 shadow-elev backdrop-blur">
        <div className="flex items-center gap-3">
          ...
          {variant.price != null ? (
            ...
            <button
              onClick={onOneClick}
              className="inline-flex max-w-[156px] items-center justify-center rounded-md bg-amber-400 px-3 py-2 text-center text-[11.5px] font-bold leading-tight text-steel-900 shadow-amber transition hover:-translate-y-0.5 hover:bg-amber-300"
            >
